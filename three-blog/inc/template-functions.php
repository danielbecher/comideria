 ...
 * @return array
 */
function three_blog_body_classes( $classes ) {
...
add_filter( 'body_class', 'three_blog_body_classes' );

/**
 * Add a pingback url auto-discovery header for single posts, pages, or attachments.
 */
function three_blog_pingback_header() {
	if ( is_singular() && pings_open() ) {
		printf( '<link rel="pingback" href="%s">', esc_url( get_bloginfo( 'pingback_url' ) ) );
	}
}
add_action( 'wp_head', 'three_blog_pingback_header' );

/**
 * three_blog Excerpt Length
 *
 * @since three_blog 1.0.0
 *
 * @param null
 * @return void
 */

if ( ! function_exists( 'three_blog_excerpt_length' ) ) :
   ...
   */
  function three_blog_excerpt_length( $length ) {
...
add_filter( 'excerpt_length', 'three_blog_excerpt_length', 999 );
